...
function App() {
  ...
  return (
    ...
    >
      ...
      {effView === "projects" && <ProjectsPage session={session} deptScope={deptScope} projects={projects} setProjects={setProjects} tasks={tasks} setTasks={setTasks} setFiles={setFiles} addAudit={addAudit} showToast={showToast}/>}
      {effView === "tasks" && <TasksPage session={session} deptScope={deptScope} tasks={tasks} setTasks={setTasks} projects={projects} users={users} setFiles={setFiles} addAudit={addAudit} showToast={showToast}/>}
      {effView === "poa" && <POAPage session={session} deptScope={deptScope} poa={poa} setPoa={setPoa} kpis={kpis} kpiWeekly={kpiWeekly} setKpiWeekly={setKpiWeekly} projects={projects} setProjects={setProjects} tasks={tasks} addAudit={addAudit} showToast={showToast}/>}
      {effView === "calendar" && <CalendarPage session={session} deptScope={deptScope} projects={projects} setProjects={setProjects} tasks={tasks} setTasks={setTasks} events={events} setEvents={setEvents} users={users} addAudit={addAudit} showToast={showToast}/>}
